...
var React = "default" in import_react ? import_react["default"] : import_react;
...
function createSelectorHook(context = ReactReduxContext) {
	...
	const useSelector2 = (selector, equalityFnOrOptions = {}) => {
		...
		const wrappedSelector = React.useCallback({ [selector.name](state) {
...
function isValidElementType(type) {
	...
	if (typeof type === "object" && type !== null) {
		if (type.$$typeof === REACT_LAZY_TYPE || type.$$typeof === REACT_MEMO_TYPE || type.$$typeof === REACT_PROVIDER_TYPE || type.$$typeof === REACT_CONTEXT_TYPE || type.$$typeof === REACT_FORWARD_REF_TYPE || type.$$typeof === REACT_CLIENT_REFERENCE || type.getModuleId !== void 0) return true;
	}
	return false;
}
		...
		function ConnectFunction(props) {
			...
			const ContextToUse = React.useMemo(() => {
				...
				if (propsContext?.Consumer) {
					if (!/* @__PURE__ */ isContextConsumer(/* @__PURE__ */ React.createElement(propsContext.Consumer, null))) throw new Error("You must pass a valid React context consumer as `props.context`");
...
initializeConnect(import_react.useSyncExternalStore);
//#endregion
